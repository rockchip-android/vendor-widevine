...
PRODUCT_COPY_FILES += vendor/widevine/lib/arm/libdrmdecrypt.so:system/lib/libdrmdecrypt.so \
	 	     vendor/widevine/lib64/arm/libdrmdecrypt.so:system/lib64/libdrmdecrypt.so \
                     vendor/widevine/lib/arm/libwvdrmengine.so:system/vendor/lib/mediadrm/libwvdrmengine.so \
		     vendor/widevine/lib64/arm/libdrmwvmplugin.so:system/vendor/lib64/drm/libdrmwvmplugin.so \
                     ...
                     vendor/widevine/lib/arm/libwvm.so:system/vendor/lib/libwvm.so \
